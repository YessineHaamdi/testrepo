...
export class UniversiteService {
  ...
  updateUniversite(universite: Universite) {
    return this.http.put(
      `${environment.baseUrl}/universite/update`,
      universite,
    );
  }
  ...
  getUniversitesWithoutFoyer() {
    return this.http.get<Universite[]>(
      `${environment.baseUrl}/universite/getUniversitesWithoutFoyer`,
    );
  }

  getUniversiteById(idUniversite: number) {
    return this.http.get<Universite>(
      `${environment.baseUrl}/universite/${idUniversite}`,
    );
  }

  getUniversiteByIdEtudiant(idEtudiant: number) {
    return this.http.get<Universite>(
      `${environment.baseUrl}/universite/getUniversiteByIdEtudiant/${idEtudiant}`,
    );
  }

  affecterFoyerAUniversite(idFoyer: number, nomUniversite: String) {
    return this.http.put(
      `${environment.baseUrl}/universite/affecterFoyer/${idFoyer}/${nomUniversite}`,
      null,
    );
  }
  ...
  desaffecterFoyerAUniversite(idUniversite: number) {
    return this.http.put(
      `${environment.baseUrl}/universite/desaffecterFoyer/${idUniversite}`,
      null,
    );
  }
  ...
  deleteUniversite(idUniversite: number) {
    return this.http.delete(
      `${environment.baseUrl}/universite/delete/${idUniversite}`,
    );
  }
}
